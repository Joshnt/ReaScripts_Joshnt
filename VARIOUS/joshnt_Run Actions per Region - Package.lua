...
-- @changelog
--  - added batch normalization (name adjust)
-- @metapackage
-- @provides
...
--   [main] joshnt_Run Actions for items tracks time or envelope of region (individually per region)/joshnt_Batch Normalize selected items (individually per overlapping item stack).lua
--   [main] joshnt_Run Actions for items tracks time or envelope of region (individually per region)/joshnt_Batch Normalize selected items - treat crossfaded items as one item (individually per overlapping item stack).lua