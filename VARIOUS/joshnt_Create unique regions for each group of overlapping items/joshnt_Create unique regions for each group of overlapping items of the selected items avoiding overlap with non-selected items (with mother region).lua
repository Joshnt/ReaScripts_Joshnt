...
if type(Mother_Region_Name_USER) == "string" then joshnt_UniqueRegions.motherRegionName = Mother_Region_Name_USER end
...
if LinkToRRM_MotherRgn_USER == 1 or LinkToRRM_MotherRgn_USER == 2 or LinkToRRM_MotherRgn_USER == 3 or LinkToRRM_MotherRgn_USER == 4 then joshnt_UniqueRegions.RRMLink_Mother = LinkToRRM_MotherRgn_USER end
if type(GroupTolerance_USER) == "number" then joshnt_UniqueRegions.groupToleranceTime = GroupTolerance_USER end
joshnt_UniqueRegions.createMotherRgn = true
...
elseif not joshnt_UniqueRegions.motherRegionName then quit("motherRegionName") return
elseif not joshnt_UniqueRegions.RRMLink_Child then quit("RRMLink_Child") return
elseif not joshnt_UniqueRegions.RRMLink_Mother then quit("RRMLink_Mother") return
