...
local function run_Button()
    ...
    joshnt_UniqueRegionsM.isolateItems = GUI.Val("isolateItems")
    joshnt_UniqueRegionsM.start_silence = GUI.Val("TimeBefore")
    joshnt_UniqueRegionsM.end_silence = GUI.Val("TimeAfter")
    joshnt_UniqueRegionsM.space_in_between = GUI.Val("TimeBetween")
    joshnt_UniqueRegionsM.lockBoolUser = optionsTable[1]
    joshnt_UniqueRegionsM.regionName = GUI.Val("RegionNameChild")
    joshnt_UniqueRegionsM.motherRegionName = GUI.Val("RegionNameMother")
    joshnt_UniqueRegionsM.RRMLink_Child = GUI.Val("RRMChild")
    joshnt_UniqueRegionsM.RRMLink_Mother = GUI.Val("RRMMother") 
    joshnt_UniqueRegionsM.createMotherRgn = GUI.Val("MotherRgnBool")
    joshnt_UniqueRegionsM.createChildRgn = GUI.Val("ChildRgnBool")
    joshnt_UniqueRegionsM.groupToleranceTime = GUI.Val("TimeInclude")
    joshnt_UniqueRegionsM.repositionToggle = GUI.Val("RepositionToggle")

    joshnt_UniqueRegionsM.main()
    if optionsTable then
        if optionsTable[2] then
            joshnt_UniqueRegionsM.saveDefaults()
...
local function setSliderSize(SliderName_String, newSliderValue_Input)
    ...
    if not newSliderValue_Input then 
        if SliderName_String == "TimeBefore" then newSliderValue = joshnt_UniqueRegionsM.start_silence
        elseif SliderName_String == "TimeAfter" then newSliderValue = joshnt_UniqueRegionsM.end_silence
        elseif SliderName_String == "TimeBetween" then newSliderValue = joshnt_UniqueRegionsM.space_in_between
        else newSliderValue = joshnt_UniqueRegionsM.groupToleranceTime end
    end
...
local function redrawColFrames()
    ...
    function GUI.elms.ColSelFrame_Child:onmouseup()
        ...
        if retval ~= 0 then 
            joshnt_UniqueRegionsM.regionColor = newColor 
        else
            joshnt_UniqueRegionsM.regionColor = nil
        end
    ...
    function GUI.elms.ColSelFrame_Mother:onmouseup()
        local retval, newColor = reaper.GR_SelectColor(nil)
        if retval ~= 0 then 
            joshnt_UniqueRegionsM.regionColorMother = newColor 
        else
            joshnt_UniqueRegionsM.regionColorMother = nil
        end
...
local function redrawAll ()
    ...
    GUI.Val("options",{joshnt_UniqueRegionsM.lockBoolUser, false, closeGUI})
end
...
local function loadDefaultValues()
    if joshnt_UniqueRegionsM.isolateItems then GUI.Val("isolateItems",joshnt_UniqueRegionsM.isolateItems) else GUI.Val("isolateItems",1) end
    if joshnt_UniqueRegionsM.space_in_between then GUI.Val("TimeBetween",joshnt_UniqueRegionsM.space_in_between) GUI.Val("TimeBetween_Text",joshnt_UniqueRegionsM.space_in_between) end
    if joshnt_UniqueRegionsM.groupToleranceTime then GUI.Val("TimeInclude",joshnt_UniqueRegionsM.groupToleranceTime) GUI.Val("TimeInclude_Text",joshnt_UniqueRegionsM.groupToleranceTime) end
    if joshnt_UniqueRegionsM.start_silence then GUI.Val("TimeBefore",joshnt_UniqueRegionsM.start_silence) GUI.Val("TimeBefore_Text",joshnt_UniqueRegionsM.start_silence) end
    if joshnt_UniqueRegionsM.end_silence then GUI.Val("TimeAfter",joshnt_UniqueRegionsM.end_silence) GUI.Val("TimeAfter_Text",joshnt_UniqueRegionsM.end_silence) end
    if joshnt_UniqueRegionsM.lockBoolUser then GUI.Val("options",{joshnt_UniqueRegionsM.lockBoolUser,false,closeGUI}) end
    if joshnt_UniqueRegionsM.regionName then GUI.Val("RegionNameChild",joshnt_UniqueRegionsM.regionName) end
    if joshnt_UniqueRegionsM.motherRegionName then GUI.Val("RegionNameMother",joshnt_UniqueRegionsM.motherRegionName) end
    if joshnt_UniqueRegionsM.RRMLink_Child then GUI.Val("RRMChild",joshnt_UniqueRegionsM.RRMLink_Child) end
    if joshnt_UniqueRegionsM.RRMLink_Mother then GUI.Val("RRMMother",joshnt_UniqueRegionsM.RRMLink_Mother) end
    if joshnt_UniqueRegionsM.createMotherRgn == true then GUI.Val("MotherRgnBool", true) end
    if joshnt_UniqueRegionsM.createChildRgn == true then GUI.Val("ChildRgnBool", true) end
    if joshnt_UniqueRegionsM.repositionToggle == true or not joshnt_UniqueRegionsM.repositionToggle then GUI.Val("RepositionToggle", true) end
    GUI.Val("Preview",previewWithTimeSelection)
    setFrameColors("Child",joshnt_UniqueRegionsM.regionColor)
    setFrameColors("Mother",joshnt_UniqueRegionsM.regionColorMother)
    setVisibilityMotherRgn()
    setVisibilityChildRgn()
end
