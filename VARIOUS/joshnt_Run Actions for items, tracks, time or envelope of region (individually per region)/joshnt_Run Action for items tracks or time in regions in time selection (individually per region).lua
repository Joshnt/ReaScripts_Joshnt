  ...
  for j=0, num_total - 1 do
    ...
    if isrgn then
      ...
      if isSelected then
        ...
        if promptAfterEachRegion and checkedRgns ~= #selectedRgns then
...
selectedRgns = joshnt.getRegionsInTimeFrame(timeRangeStart, timeRangeEnd)
