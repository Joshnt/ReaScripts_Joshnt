...
local function main()
    ...
    reaper.Main_OnCommand(reaper.NamedCommandLookup("_SWS_SELNEXTREG"),0) -- timeselect previous region
    ...
    if curPosOld > curPosNew then
        ...
        reaper.TrackCtl_SetToolTip("Zoomed to first region in project", x+17, y+17, false )
    end
end
