...
local selMarkerTable, _ = joshnt.getSelectedMarkerAndRegionIndex()
if not selMarkerTable then joshnt.TooltipAtMouse("No marker selected") return end
local markerWantIndex = selMarkerTable[1]
...
reaper.Undo_EndBlock('Move selected items to selected marker/ region', -1)