...
local function main()
    ...
    local selRgns = joshnt.getSelectedMarkerAndRegionIndex()

    -- all or no regions selected
    if not selRgns or num_regions == #selRgns or not selRgns[1] then
    ...
    for j=0, num_total - 1 do
        ...
        if isrgn and not joshnt.tableContainsVal(selRgns,markrgnindexnumber) then
...
reaper.Undo_EndBlock('Invert Region Selection', -1)